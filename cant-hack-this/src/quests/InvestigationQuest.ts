...
export class InvestigationQuest extends Quest<InvestigationData> {
    ...
    QuestName = "CantHackThisInvestigation";
    ...
    Mails = [
        {
            ...
            subject: "Job Offer: Network Investigation",
    ...
    Objectives = [
        {
            ...
            description: "Run nmap on 45.33.32.156",
        },
        {
            id: "connect",
            title: "Gain remote access",
            description: "Connect to 45.33.32.156 via SSH, FTP, or any remote service",
